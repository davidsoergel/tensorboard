...
from tensorboard.plugins.graph_v2 import graph_v2_metadata

logger = tb_logging.get_logger()

class GraphV2Plugin(base_plugin.TBPlugin):
  plugin_name = graph_v2_metadata.PLUGIN_NAME

  def __init__(self, context):
    self._multiplexer = context.multiplexer

  def is_active(self):
    return bool(self._multiplexer.PluginRunToTagToContent(graph_v2_metadata.PLUGIN_NAME))
